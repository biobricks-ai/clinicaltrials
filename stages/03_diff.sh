...
export DEFUALT_DUCKDB_MEMORY_LIMIT=$(duckdb -ascii -noheader  -c "SELECT current_setting('memory_limit');");

export CTGOV_DUCKDB_TEMP_DIR=${CTGOV_DUCKDB_TEMP_DIR:-}
export CTGOV_DUCKDB_MEMORY_LIMIT=${CTGOV_DUCKDB_MEMORY_LIMIT:-${DEFUALT_DUCKDB_MEMORY_LIMIT}}
